 ...
 */
public class ListItemDecorationUtil extends RecyclerView.ItemDecoration {
     ...
     */
    public ListItemDecorationUtil(Context context, int space, int margin) {
        if (space == 0) {
            // 获取默认主题的属性
