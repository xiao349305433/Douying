...
public class SineView extends View {
    ...
    protected void initialize() {
        LinearGradient linearGradient = new LinearGradient(0, 0, 100, 200, new int[] { getResources().getColor(R.color.start),getResources().getColor(R.color.end) }, null, Shader.TileMode.REPEAT);
