...
public class SpanUtils {
    ...
    public static SpannableString getForegroundColorSpan(Context context,String str,String str1){
        SpannableString spannableString = new SpannableString(str);
        int start=str.indexOf(str1);
        int end=start+str1.length();
        ForegroundColorSpan foregroundColorSpan = new ForegroundColorSpan(context.getResources().getColor(R.color.pointtask_Orange));
    ...
    public static SpannableString getBackgroundColorSpan(Context context){
        ...
        BackgroundColorSpan backgroundColorSpan = new BackgroundColorSpan(context.getResources().getColor(R.color.pointtask_Orange));
