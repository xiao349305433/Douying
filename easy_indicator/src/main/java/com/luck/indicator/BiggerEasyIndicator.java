...
public class BiggerEasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    public BiggerEasyIndicator(Context context) {
        super(context);
    }

    public BiggerEasyIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setOnTabClickListener(BiggerEasyIndicator.onTabClickListener onTabClickListener) {
