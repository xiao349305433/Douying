...
public class BoxEasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private float indicator_select_textSize = 18; // 选中字体大小
    private boolean indicator_isBottom_line = true;// 是否显示指示器
    private int position;
    private ViewPager viewPager;

    public BoxEasyIndicator(Context context) {
        super(context);
    }

    public BoxEasyIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    private void init(TypedArray a) {
        ...
        // indicator_bottom_height  指示器默认高度
        ...
        // indicator_bottom_line_height  指示器底部线高度
        ...
        // indicator_bottom_line_color   指示器底部线颜色
        ...
        // indicator_vertical_line_color  中间分割线颜色
        ...
        // indicator_vertical_line_h   中间分割线高度
        ...
        indicator_select_textSize = getDimensionPixelSize(a, R.styleable.MyIndicator_indicator_select_textSize, 18);
       ...
       // tab_content.setBackgroundColor(Color.WHITE);
        tab_content.setBackground(getResources().getDrawable(R.drawable.box_shape));
    ...
    public void setOnTabClickListener(BoxEasyIndicator.onTabClickListener onTabClickListener) {
