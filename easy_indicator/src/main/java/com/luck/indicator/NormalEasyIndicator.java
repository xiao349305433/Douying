...
public class NormalEasyIndicator extends LinearLayout implements View.OnClickListener, ViewPager.OnPageChangeListener {
    ...
    private float indicator_select_textSize = 14; // 选中字体大小
    private boolean indicator_isBottom_line = true;// 是否显示指示器
    private int position;
    private ViewPager viewPager;

    public NormalEasyIndicator(Context context) {
        super(context);
    }

    public NormalEasyIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void setOnTabClickListener(NormalEasyIndicator.onTabClickListener onTabClickListener) {
